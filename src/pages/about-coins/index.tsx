...
const AboutCoins: NextPage = () => {
    const { data: methods, isLoading: methodsLoading } = trpc.useQuery(['coins.getMethods'])
        ...
        <>
            ...
            <div className={styles.mainColumn}>
                <div className={styles.description}>
                    ...
                    <span>
                        Sed tempus sem ac libero venenatis, malesuada
                        rhoncus tellus gravida. Etiam vitae leo pretium,
                        fermentum lectus interdum, imperdiet dui. Cras cursus
                        non elit et feugiat. Nunc mi diam, pulvinar vel nunc
                        eget, sodales auctor erat. Etiam fringilla sollicitudin
                        accumsan. Phasellus at urna lectus. Phasellus at urna lectus.
                        Cras eleifend purus volutpat dolor volutpat placerat.
                        Morbi ut dolor tempor, euismod eros eget, bibendum enim.
                        Donec mattis dolor est, eu placerat tortor commodo id.
                        Fusce purus quam, eleifend eu lacus ac, tempus molestie
                        arcu. Nunc sagittis condimentum purus, vel iaculis nisi
                        efficitur vitae.
                    </span>
                </div>
                <div className={styles.description}>
                    ...
                    <span>
                        ...
                        tellus gravida. Etiam vitae leo pretium, fermentum lectus
                        interdum, imperdiet dui.
                    </span>
                </div>
                <div className={styles.methods}>
                    {methods.map((method, index) => (
                        <Method {...method} key={`method_${index}`} />
                    ))}
                </div>
            </div>
        </>
        ...
        <div className={styles.method}>
            <div className={styles.info}>
                ...
                <div className={styles.text}>
                    <h4>{text}</h4>
                    <span>For completing this task you will recieve <b>{reward} coins</b></span>
                </div>
            </div>
